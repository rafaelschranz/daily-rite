...
- **Stille-Dauer wählbar** (3/5/10 Minuten) auf dem Auswahl-Screen.
- **Fokus-Modus:** In jedem laufenden Schritt (nicht nur der Stille) blenden Header, Fortschrittspunkte und Controls nach 5 Sekunden Inaktivität aus; ein Tap auf die Fläche holt sie kurz zurück. Jeder neue Schritt startet wieder sichtbar. Der eigentliche Inhalt (Vers, Gebetstext, Kerze) bleibt davon unberührt.
